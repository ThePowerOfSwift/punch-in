...
extension UIViewController {
    ...
    func addJobView(to contentView: UIView, for delegateView: UIViewController) -> UIView {
        ...
        jobNameTextField.delegate = delegateView as? JobsViewController
        ...
        hourlyRateTextField.delegate = delegateView as? JobsViewController
